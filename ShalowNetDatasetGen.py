...
def getDataset():
    ...
    ModelCut = Model(inputs=model.input,
                     outputs=model.layers[-2].output)  # Gets the same network without last layer
    ...
    np.savez('Datasets.npz', name1=x_train, name2=y_trainHard, name3=y_trainSoft, name4=x_test,
             name5=y_testHard, name6=y_testSoft)
